...
sorcerer = Player.new(2, 7, 4, 7) # low - - high

fighter_monster = Monster.new(8, 3, 5, 4)
rogue_monster = Monster.new(5, 5, 7, 3)
cleric_monster = Monster.new(5, 7, 3, 5)
sorcerer_monster = Monster.new(2, 7, 4, 7)
